...
public class ArtifactTypeParser {
   ...
   public static void main(String[] args) {
       ...
       Path AtifactTypeFilePath=Path.of("C:/Users/LAPTOP/Documents/GitHub/winery/org.eclipse.winery.lsp/src/test/resources/testArtifactType.yaml");
       parser.parseYAMLFile(AtifactTypeFilePath);
        System.out.println("Artifact type:  "+parser.getArtifacttype());
       System.out.println("the error problem: "+parser.getErrorProblem());
    }
}
